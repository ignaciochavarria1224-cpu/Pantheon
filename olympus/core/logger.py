...
Timestamps are rendered in US/Eastern (the market timezone) using the stdlib
zoneinfo — no third-party timezone dependency.
"""
...
class _ETFormatter(logging.Formatter):
    ...
    def formatTime(self, record: logging.LogRecord, datefmt: str | None = None) -> str:
        utc_dt = datetime.datetime.fromtimestamp(record.created, tz=_UTC)
